...
**Last verified against:** v0.2 — VS Code extension with bundled binaries and packed `vscode-languageclient`; restart-server command registers even when the language server fails to start; Marketplace publish on each push to `main`
