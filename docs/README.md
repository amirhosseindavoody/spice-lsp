...
**Last verified against:** VS Code Create Demo Folder command; include/lib resolution, multi-dialect hover (default HSPICE), outline/navigation/diagnostics; completion, formatter, and connectivity still planned
